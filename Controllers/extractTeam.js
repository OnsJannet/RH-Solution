...
async function extractTeamData(excelFilePath, sheetName) {
  ...
  try {
    ...
    const collection = database.collection("RH"); // Use the specified collection name
...
module.exports = extractTeamData;
